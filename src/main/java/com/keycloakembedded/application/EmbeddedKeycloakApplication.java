package com.keycloakembedded.application;
...
import com.keycloakembedded.properties.KeycloakServerProperties.AdminUser;

public class EmbeddedKeycloakApplication extends KeycloakApplication {
	
	 private static final Logger LOG = org.slf4j.LoggerFactory.getLogger(EmbeddedKeycloakApplication.class);
...
//	    }
	    ...
	    private void createMasterRealmAdminUser() {
	        ...
	        AdminUser admin = getKeycloakServerProperties().getAdminUser();
//	        AdminUser admin = new AdminUser("admin","");
	    ...
	    private void createBaeldungRealm() {
	        ...
	        try {
	            ...
	            org.springframework.core.io.Resource lessonRealmImportFile = new ClassPathResource(
	              getKeycloakServerProperties().getRealmImportFile());
