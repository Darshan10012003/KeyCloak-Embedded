package com.keycloakembedded.config;
...
import com.keycloakembedded.filter.EmbeddedKeycloakRequestFilter;
...
//        mockJndiEnvironment(dataSource);
        com.keycloakembedded.application.EmbeddedKeycloakApplication.setKeycloakServerProperties(keycloakServerProperties);
        ...
        servlet.addInitParameter("jakarta.ws.rs.Application", 
          com.keycloakembedded.application.EmbeddedKeycloakApplication.class.getName());
        servlet.addInitParameter(ResteasyContextParameters.RESTEASY_SERVLET_MAPPING_PREFIX,
          "/auth");
        servlet.addInitParameter(ResteasyContextParameters.RESTEASY_USE_CONTAINER_FORM_PARAMS, 
          "true");
        servlet.addUrlMappings("/auth" + "/*");
